  ...
  <main class="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row md:space-x-6">
    ...
    <section class="flex-1">
      ...
      <div class="flex items-start space-x-3 border border-black rounded-lg bg-[#f7efe1] p-4 mb-6 max-w-4xl">
        <a href="https://www.google.com/maps/search/?api=1&query=Politeknik+Negeri+Batam" target="_blank" rel="noopener noreferrer" class="text-black mt-1">
      ...
      <div class="bg-[#f7efe1] rounded-xl p-6 space-y-6 max-w-4xl">
        ...
        <div class="flex items-center space-x-4 item" data-price="100000">
          <div class="flex flex-col items-center space-y-2 pr-2 border-r border-black">
            <button class="text-black text-lg cursor-pointer delete-btn" aria-label="Delete Fender Sonic Grey">
          ...
          <img src="https://storage.googleapis.com/a1aa/image/24e6f889-e187-4ced-dc2d-7d6e757807ce.jpg" alt="Fender Sonic Grey" class="rounded-lg" width="100" height="100">
          <div class="flex-1">
        ...
        <div class="flex items-center space-x-4 item" data-price="150000">
          <div class="flex flex-col items-center space-y-2 pr-2 border-r border-black">
            <button class="text-black text-lg cursor-pointer delete-btn" aria-label="Delete Cecilio CVN-100">
              <i class="fas fa-trash-alt"></i>
            </button>
          ...
          <img src="https://storage.googleapis.com/a1aa/image/1eef423e-83af-4a2e-210f-85b2e74696bd.jpg" alt="Cecilio CVN-100" class="rounded-lg" width="100" height="100">
          <div class="flex-1">
    ...
    <aside class="w-full md:w-72 bg-[#f7efe1] rounded-xl p-4 mt-6 md:mt-0 flex flex-col items-stretch gap-4 self-start">
      ...
      <button class="bg-[#a38f7f] text-black font-extrabold rounded-md py-2 w-full hover:bg-[#8a7a6a] transition-colors">
        Bayar Sekarang
      </button>
    </aside>
