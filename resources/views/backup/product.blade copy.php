...
@section('body_class', 'bg-[#fdfaf5] text-gray-800 font-sans')
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-start px-6 md:px-12 relative z-10 pt-10">
            ...
            <div class="space-y-6">
                <div
                    ...
                    <img id="mainImage"
    src="{{ asset('storage/' . ($product->images[0] ?? 'fallback.jpg')) }}"
    alt="{{ $product->name }}"
    class="object-contain w-full h-[420px] transition duration-300" />
                    <span
    ...
    @foreach ($product->images as $image)
        <img onclick="document.getElementById('mainImage').src='{{ asset('storage/' . $image) }}'"
