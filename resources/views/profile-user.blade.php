    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="bg-[#f7efe1] rounded-lg mt-8 mb-4 p-4 w-full shadow-md">
            ...
            <div class="flex justify-around pt-4 flex-wrap">
                <!-- Unpaid Button -->
                <button class="text-center text-[#5a534d] flex-1 min-w-[150px] mb-4 py-4 px-2 rounded-lg bg-transparent hover:bg-[#f6e8d6] transition-all duration-300">
            ...
            <div class="bg-[#f7efe1] rounded-lg mt-8 mb-4 p-4 w-full max-w-7xl shadow-md">
                ...
                <main class="flex-1 p-8 animate-fade-in">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
                        <!-- Product 1 -->
                        <div class="bg-[#f2e0c9] rounded-2xl border border-[#e0d5cb] shadow-md hover:shadow-lg transition-transform transform hover:-translate-y-1 scale-105 p-4 flex flex-col items-center text-center">
                    ...
                    <div class="pt-20 flex justify-start">
                        <button class="border border-[#5a534d] rounded-lg bg-transparent text-[#5a534d] font-semibold px-4 py-2 text-sm flex items-center space-x-2 hover:bg-[#f3e6d3] hover:text-[#5a534d] transition-all transform hover:scale-105 hover:shadow-lg shadow-md">
