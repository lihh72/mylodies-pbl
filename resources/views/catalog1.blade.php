        ...
        <div class="max-w-8xl mx-auto px-6 relative z-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 px-4 lg:px-8">
                @foreach([
                    ...
                    ['img' => 'bass1.avif', 'name' => 'Ibanez EDB405 Bass', 'price' => 'IDR 350.000 / Day', 'desc' => 'Powerful tone, perfect for rock.', 'cat' => 'Guitars'],

                    // Aerophones
                    ['img' => 'saxophone.jpg', 'name' => 'Yamaha Saxophone', 'price' => 'IDR 350.000 / Day', 'desc' => 'Expressive jazz sound.', 'cat' => 'Aerophones'],
                    ['img' => 'flute.jpg', 'name' => 'Silver Flute', 'price' => 'IDR 280.000 / Day', 'desc' => 'Bright and pure sound.', 'cat' => 'Aerophones'],
                    ['img' => 'clarinet.jpg', 'name' => 'Buffet Clarinet', 'price' => 'IDR 300.000 / Day', 'desc' => 'Classic orchestral timbre.', 'cat' => 'Aerophones'],

                    // Traditional
                    ['img' => 'drum.jpg', 'name' => 'Drum Set', 'price' => 'IDR 380.000 / Day', 'desc' => 'Crisp snare and booming bass.', 'cat' => 'Traditional'],
                    ['img' => 'angklung.jpg', 'name' => 'Angklung Set', 'price' => 'IDR 200.000 / Day', 'desc' => 'Sundanese bamboo instrument.', 'cat' => 'Traditional'],
                    ['img' => 'gamelan.jpg', 'name' => 'Mini Gamelan', 'price' => 'IDR 400.000 / Day', 'desc' => 'Balinese percussive ensemble.', 'cat' => 'Traditional'],

                    // Favorites
                    ['img' => 'accordion.jpg', 'name' => 'Accordion', 'price' => 'IDR 330.000 / Day', 'desc' => 'Colorful for folk and polka.', 'cat' => 'Favorites'],
                    ['img' => 'ukulele.jpg', 'name' => 'Soprano Ukulele', 'price' => 'IDR 180.000 / Day', 'desc' => 'Light, fun sound for beginners.', 'cat' => 'Favorites'],
                    ['img' => 'cajon.jpg', 'name' => 'Cajon Box Drum', 'price' => 'IDR 220.000 / Day', 'desc' => 'Portable and rhythmic.', 'cat' => 'Favorites'],
                ] as $item)
