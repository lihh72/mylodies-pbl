    ...
    <section class="space-y-14">
      <div class="relative rounded-[2rem] border border-[#decdb5] bg-[#fcf8f4] p-10 shadow-2xl">
        ...
        <div class="mt-8">
          ...
          <textarea id="notes" rows="4" placeholder="Add delivery info, preferences, or special instructions…" class="w-full bg-[#fffdf9] border border-[#eadbc3] rounded-xl p-4 text-sm shadow-inner focus:ring-2 focus:ring-[#d6bfa4] focus:outline-none resize-none"></textarea>
        </div>
