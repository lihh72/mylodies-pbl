...
<!-- Hero Section -->
<section id="home" class="relative h-[100vh] bg-cover bg-center flex items-center justify-center text-center overflow-hidden" style="background-image: url('{{ asset('images/bg.jpg') }}');">
  <!-- Overlay -->
...
<section class="bg-[#f9f3ea] py-20 relative overflow-hidden">
  ...
  <div class="max-w-7xl mx-auto px-6 relative z-10">
    ...
    <div class="flex flex-wrap justify-center items-center gap-12">
      ...
      <div class="grayscale hover:grayscale-0 transition-all duration-300 ease-in-out">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Shure_Logo_2024.svg/960px-Shure_Logo_2024.svg.png" class="h-14 md:h-16" alt="Partner 3" />
      </div>
