...
<body class="bg-[#fef8f2] text-[#5a4a3b] font-sans pt-[60px]">
    ...
    <div class="flex min-h-[calc(100vh-60px)]">
        ...
        <aside class="bg-[#f3e6d3] w-[300px] p-8 flex flex-col items-center shadow-inner">
            ...
            <button class="flex items-center gap-3 px-5 py-3 rounded-full border border-[#a9937f] bg-gradient-to-r from-[#e9d6c3] to-[#a9937f] text-[#5a4a3b] text-sm font-medium transition-all transform hover:scale-105 shadow-lg hover:shadow-2xl hover:bg-[#f3d0a9] focus:outline-none focus:ring-2 focus:ring-[#a9937f] focus:ring-opacity-50">
